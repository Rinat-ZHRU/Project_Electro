...
from products_app.views import ProductViewSet, BrandViewSet, BranchViewSet, CategoryViewSet

urlpatterns = [
    path('category/', CategoryViewSet.as_view({'get': 'list', 'post': 'create'}, name='Категории')),
